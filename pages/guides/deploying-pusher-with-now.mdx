...
export const meta = {
  ...
  published: '2019-08-19T17:01:20.896Z',
  authors: ['coetry'],
  url: '/guides/deploying-pusher-with-now',
  image: '',
  editUrl: 'pages/guides/deploying-pusher-with-now.mdx',
  lasEdited: '2019-08-19T17:01:20.896Z',
  lastEdited: '2019-08-20T19:14:47.000Z'
}
