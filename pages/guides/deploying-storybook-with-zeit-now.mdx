...
export const meta = {
  ...
  lastEdited: '2019-08-20T15:15:29.000Z'
}
...
By adding these scripts you are able to start a development server from inside your project directory with `npm storybook`. You are also able to deploy the Storybook component library to [ZEIT Now](/now) with no additional configuration.
